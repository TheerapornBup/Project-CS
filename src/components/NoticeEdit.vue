    ...
    <v-container>
      <div class="card">
        ...
        <v-row>
          ...
          <v-col cols="4">
            <v-checkbox label="ประกาศตามหาของหาย" @click="setSelectedMenu('ประกาศตามหาของหาย')"></v-checkbox>
          </v-col>
          <v-col cols="4">
            <v-checkbox label="ประกาศพบเจอของหาย" @click="setSelectedMenu('ประกาศพบเจอของหาย')"></v-checkbox>
          </v-col>
        </v-row>
              ...
              <v-container>
                <v-row>
                  ...
                  <v-col cols="6" >
                    ...
                    <v-select class="mt-3" style="width:auto" variant="solo" required v-model="itemType"
                    :items="['บัตรสำคัญประจำตัว', 'เงิน', 'กระเป๋า', 'อุปกรณ์อิเล็กทรอนิกส์', 'เครื่องประดับ', 'เครื่องสำอาง','เอกสาร','เสื้อผ้า','แว่นตา','กุญแจ','อุปกรณ์กีฬา','อุปกรณ์ถ่ายภาพ','เครื่องเขียน','หนังสือ','อุปกรณ์ทางการแพทย์','รองเท้า']"
                ...
                <v-row>
                  ...
                  <v-col cols="6" >
                    ...
                    <v-textarea class="mt-3" variant="solo" v-model="detail"></v-textarea>
                  </v-col>
                  <v-col cols="4"> 
                    <v-text class="topic">วันที่ทำของหาย หรือพบเจอของหาย</v-text>
                    <VueDatePicker v-model="dateTime" class="mt-3" variant="solo" ></VueDatePicker>
                    <v-col cols="1"></v-col>
                ...
                <v-row>
                  <v-col cols="4"></v-col>
                  <v-col cols="2">
                    <v-btn class="save-btn mt-2" @click="addNotice()">บันทึก</v-btn>
      ...
      <script>
        ...
        methods: {
          setShowDialog(isShow) {
            ...
            if (!isShow) {
              if (
                this.dialog.content === "สร้างประกาศสำเร็จ"
              ) {
          ...
          async addNotice(){
              ...
              console.log("picture>"+picture+"noticeId>"+noticeId);
              this.dialog = {
                value: true,
                type: "success",
